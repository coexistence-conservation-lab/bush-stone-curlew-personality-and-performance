...
#pacman::p_load(tidyverse, janitor, lubridate, SDLfilter, ggmap, amt, gganimate, sp, terra, adehabitatHR, sf, glmmTMB, adehabitatLT, wildlifeDI, gtools, performance)

pacman::p_load(glmmTMB, tidyverse)

ggmap::register_google(key = "AIzaSyAH3qnqmxDATEluG8lKt2KtnHKLYJc2WaM")

setwd("D:/Spring 2022 Release MR")
