...
# Load packages
pacman::p_load(beepr, contsurvplot, ggpubr, glmmTMB, janitor, MuMIn, patchwork, performance, readxl, sjPlot, survival, survminer, tidyverse)
...
survival <- read.csv("Input/survival.csv") %>%
  ...
  mutate(to_90 = ifelse(to_90 == FALSE, 0, 1),
         to_363 = ifelse(to_360 == FALSE, 0, 1)) %>%
# Drop unneeded columns
  dplyr::select(c(bird, persist, to_90, to_363))
