...
# Load packages
pacman::p_load(amt, beepr, ggmap, ggpubr, glmmTMB, janitor, SDLfilter, segclust2d, 
               solitude, suncalc, terra, tidyverse)
...
map <- get_map(c(144.4360, -37.9000), zoom=13, maptype = "satellite")
...
# Save to file
write.csv(speed_filt, "Processed/GPSdata_filtered.csv", row.names = FALSE)
