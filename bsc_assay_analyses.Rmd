...
The difference between the curves is weakly significant. Females are less likely to survive. 
...
Evidence for effect of latency (on the log rank test). Visually, shorter latency periods have higher survival likelihoods.
...
First a violin plot with the continuous variables (latency to reach food, time alert and weight) for the two time periods.
...
Next a mosaic plot with the categorical variables (handling score and sex) for the two time periods.
